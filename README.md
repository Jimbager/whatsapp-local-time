...
2. 支持多种识别方式：
   - **国家/地区名称**：如"巴基斯坦 Yasir"、"中国 张三"（支持中英文）
   - **带+号的国际电话号码**：如"+92 300 6526074"
   - **不带+号的区号**：如"92 300 6526074"、"86 13800138000"
3. 在联系人名称下方或旁边显示当前的当地时间
4. 时间每分钟自动更新一次，并显示工作时间状态（🟢 工作时间 / 🔴 非工作时间）
...
1. **联系人识别方式**
   - **国家/地区名称**：联系人名称包含国家/地区名称（支持中英文），如"巴基斯坦 Yasir"、"USA John"、"中国 张三"
   - **完整电话号码**：联系人名称包含国际电话号码，如"+92 300 6526074"、"+86 13800138000"
   - **区号识别**：联系人名称以区号开头，如"92 300 6526074"、"86 13800138000"（新增功能）
   - 如果联系人名称不包含上述任何信息，则无法自动识别时区
2. **打开 WhatsApp Web**
   - 访问 https://web.whatsapp.com/
   - 登录您的 WhatsApp 账号
3. **查看时间信息**
...
- **智能识别** - 支持多种联系人信息格式（国家名称、完整电话号码、区号）
...
**Q: 插件无法识别联系人国家/地区？**
A: 请检查联系人名称是否包含以下任一格式：

- 国家/地区名称：如"中国 张三"、"USA John"、"巴基斯坦 Yasir"
- 完整国际电话号码：如"+86 13800138000"、"+92 300 6526074"
- 区号开头：如"86 13800138000"、"92 300 6526074"（v1.1 新增）
...
- **v1.1** - 功能改进版本
  - **新增**：支持不带+号的区号识别（如"92 300 6526074"）
  - **改进**：增强电话号码识别逻辑
  - **优化**：清理未使用的代码和文件
  - **修复**：代码中的重复条目和语法问题
  - **增强**：工作时间状态显示更加明显
...
[点击查看隐私政策](https://raw.githubusercontent.com/Jimbager/whatsapp-local-time/master/PRIVACY.md)
...
本扩展不收集、存储或传输任何个人数据。所有处理均在您的设备本地进行。

## 权限使用

- **scripting**: 仅用于在 WhatsApp Web 中显示时间信息
- **storage**: 仅保存扩展启用/禁用状态
- **host permissions**: 仅限 WhatsApp Web 官方网站
...
GitHub: https://github.com/Jimbager/whatsapp-local-time
